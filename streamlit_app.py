...
srt.title("App by PS")
srt.markdown(f"<style> -appview-container.css-cc9aqqtcatxzadr5pjc9co {background-image:linear-gradient(Azure,RoyalBlue); color:#FFFFFF'}</style>", unsafe_allow_html=True )
